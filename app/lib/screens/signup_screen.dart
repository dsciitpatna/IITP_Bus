...
GlobalKey<FormFieldState<String>> field1Key = GlobalKey<FormFieldState<String>>();
GlobalKey<FormFieldState<String>> field2Key = GlobalKey<FormFieldState<String>>();
GlobalKey<FormFieldState<String>> field3Key = GlobalKey<FormFieldState<String>>();
GlobalKey<FormFieldState<String>> field4Key = GlobalKey<FormFieldState<String>>();
GlobalKey<FormFieldState<String>> field5Key = GlobalKey<FormFieldState<String>>();
GlobalKey<FormFieldState<String>> field6Key = GlobalKey<FormFieldState<String>>();
...
final emailfieldsignup = TextFormField(
  ...
  validator: (value) {
    ...
    else if (!RegExp(r"^[^\s@]+@[^\s@]+\.(?!iitp\.ac\.in)[^\s@]+$").hasMatch(value)) {
...
class _SignUpState extends State<SignUp> {
  ...
  if (_formkeysignup.currentState!.validate()) {
    ...
    if (_checked!) {
      ...
      Fluttertoast.showToast(msg: 'Accept the terms and conditions to proceed');
    }
  }
